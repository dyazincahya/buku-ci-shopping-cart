			...
			<div id="container" class="left">
				<div id="content">
					...
					<div class="light-block">
						<p class="block-title">FeedBack</p>
						<div>
							<div class="comment-form">
							<?php if ($this->session->flashdata('message'))echo $this->session->flashdata('message');?>
								<form action="<?php echo site_url('homepage/kontak');?>" onsubmit="return validasi()" method="POST">
									<p class="form-name">
									...
									<p class="form-name">
										<label for="">Subjek:<span class="required">*</span></label>
									...
									<p class="form-name">
										<label for="">Pesan:<span class="required">*</span></label>
										<textarea name="isi" placeholder="Tulis Pesan..." id="isi"></textarea>
									</p>
