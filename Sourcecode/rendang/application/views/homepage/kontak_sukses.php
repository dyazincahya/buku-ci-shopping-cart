					...
					<div class="light-block">
						<div>
							<div class="comment-form">
								<p class="block-title">Pemberitahuan</p>
								<h3>FeedBack Telah Terkirim</h3>
								<a href="<?php echo site_url('homepage/kontak');?>" class="button" style="background-color: #E45nde;">Kembali Ke Form</a>
							</div>
						</div>
					<!-- END .light-block -->
					</div>
