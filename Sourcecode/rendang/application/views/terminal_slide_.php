...
<?php $this->load->view('adm_navbar');?>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="alert alert-success" role="alert">
				<span class="glyphicon glyphicon-pushpin"></span> Primary Berhasil Di Update 
				<span class="glyphicon glyphicon-thumbs-up"></span>
			</div>
			<a href="<?php echo site_url('admin/slide');?>" class="btn btn-primary"><span class="glyphicon glyphicon-circle-arrow-left"></span> Back</a>
        </div>
      </div>
    </div>
