...
<?php $this->load->view('adm_navbar');?>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#add">Add Produk</button>
			<!-- Modal Pembatalan-->
			<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
				  <div class="modal-content">
					<?php echo form_open_multipart('admin/save_produk'); ?>
					...
					<div class="modal-body">
						...
						<input type="hidden" name="kd_barang" value="<?php echo rand(1,10000);?>">
					...
					<div class="modal-footer">
						...
						<input type="submit" class="btn btn-primary" name="submit" value="Add Produk">
					</div>
					<?php echo form_close();?> 
				  </div>
				</div>
