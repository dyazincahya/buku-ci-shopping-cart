...
<?php $this->load->view('adm_navbar');?>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<?php foreach($pri as $val);?>
			<a href="<?php echo site_url('admin/slide_key/edit/'.$val->id);?>"><button class="btn btn-primary"><span class="glyphicon glyphicon-pushpin"></span> Primary Slide</button></a>
