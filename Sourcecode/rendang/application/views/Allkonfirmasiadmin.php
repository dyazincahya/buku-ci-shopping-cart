...
<?php $this->load->view('adm_navbar');?>
		...
		<div class="page-header">
			...
			<ul id="myTab" class="nav nav-tabs">
				<li class="active"><a href="#konfir" data-toggle="tab">
							...
							<div class="modal-dialog">
							  <div class="modal-content">
								...
								<div class="modal-footer">
								  <form action="<?php echo site_url('admin/Proses/'.$val->kode_pesanan);?>" method="POST">
					...
					<table class="table table-striped">
					  ...
					  <tbody>
						<tr>
						  ...
						  <td><a href="#" data-toggle="modal" data-target="#selesai<?php echo $val2->kode_pesanan;?>">Selesai</a></td>
						</tr>
					  </tbody>
					  <!-- Modal Konfir pesanan-->
						<div class="modal fade" id="selesai<?php echo $val2->kode_pesanan;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
							<div class="modal-dialog">
							  <div class="modal-content">
								<div class="modal-header">
								  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
								...
								<div class="modal-footer">
								  <form action="<?php echo site_url('admin/Selesai/'.$val2->kode_pesanan);?>" method="POST">
									<input type="button" class="btn btn-default" data-dismiss="modal" value="Close">
