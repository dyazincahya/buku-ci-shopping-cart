        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <hr>
			<div class="alert alert-success" role="alert">
				<span class="glyphicon glyphicon-check"></span> FeedBack Terlah Berhasil Dikirim 
				<span class="glyphicon glyphicon-thumbs-up"></span>
			</div>
			<a href="<?php echo site_url('admin/kontak');?>" class="btn btn-primary"><span class="glyphicon glyphicon-circle-arrow-left"></span> Back</a>
        </div>
      </div>
    </div>
